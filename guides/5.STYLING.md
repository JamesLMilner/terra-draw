...
| `pointOpacity`       | Number (0-1) | `0.7`         | The fill opacity of the point    |
| `pointWidth`         | Integer      | `2`           | The width of the point           |
| `pointOutlineColor`  | Hex Color    | `#00FFFF`     | The outline color of the point   |
| `pointOutlineOpacity`| Number (0-1) | `0.7`         | The outline opacity of the point |
...
| `outlineOpacity`           | Number (0-1) | `0.7`         | The outline opacity of the polygon     |
...
| `outlineOpacity` | Number (0-1) | `0.7`       | The outline opacity of the circle |
...
| `outlineOpacity` | Number (0-1) | `0.7`       | The outline opacity of the sector  |
...
| `centerPointOpacity`         | Number (0-1) | `0.9`         | The fill opacity of the center point            |
...
| `centerPointOutlineOpacity`  | Number (0-1) | `0.9`         | The outline opacity of the center point         |
...
| `outlineOpacity`             | Number (0-1) | `0.7`         | The outline opacity of the sensor               |
...
| `selectedPointOpacity`        | Number (0-1) | `0.7`         | The fill opacity of the point    |
...
| `selectedPointOutlineOpacity` | Number (0-1) | `0.7`         | The outline opacity of the point |
...
| `selectedLineStringOpacity` | Number (0-1) | `0.7`         | The opacity of the line |
...
| `selectedPolygonOutlineOpacity` | Number (0-1) | `0.7`       | The outline opacity of the polygon |
...
| `selectionPointOpacity`        | Number (0-1) | `0.7`         | The fill opacity of the selection point    |
| `selectionPointOutlineColor`   | Hex Color    | `#00FF00`     | The outline color of the selection point   |
| `selectionPointOutlineOpacity` | Number (0-1) | `0.7`         | The outline opacity of the selection point |
...
| `midPointOpacity`        | Number (0-1) | `0.7`         | The fill opacity of the mid point    |
| `midPointOutlineColor`   | Hex Color    | `#00FFFF`     | The outline color of the mid point   |
| `midPointOutlineOpacity` | Number (0-1) | `0.7`         | The outline opacity of the mid point |
