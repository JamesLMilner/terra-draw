...
describe("TerraDrawRectangleMode", () => {
	...
	describe("onDrag", () => {
		...
		it("without clickAndDrag option it does nothing", () => {
			rectangleMode = new TerraDrawRectangleMode();
		...
		it("with clickAndDrag false it does nothing", () => {
			const rectangleMode = new TerraDrawRectangleMode({
				clickAndDrag: false,
			});
		...
		it("with clickAndDrag true and onDrag pointer event set to false it does nothing", () => {
			const rectangleMode = new TerraDrawRectangleMode({
				clickAndDrag: true,
				pointerEvents: {
					...DefaultPointerEvents,
		...
		it("with clickAndDrag true and drawType is click it does nothing", () => {
			const rectangleMode = new TerraDrawRectangleMode({
				clickAndDrag: true,
			});
		...
		it("with clickAndDrag true it updates the rectangle size", () => {
			const rectangleMode = new TerraDrawRectangleMode({
				clickAndDrag: true,
			});
	...
	describe("onDragStart", () => {
		...
		it("with clickAndDrag true and onDragStart pointer event false it does nothing", () => {
			rectangleMode = new TerraDrawRectangleMode({
				clickAndDrag: true,
				pointerEvents: {
					...DefaultPointerEvents,
		...
		it("with click and drag true it begins drawing", () => {
			rectangleMode = new TerraDrawRectangleMode({
				clickAndDrag: true,
			});
	...
	describe("onDragEnd", () => {
		...
		it("with clickAndDrag true and onDragEnd pointer event false it does nothing", () => {
			rectangleMode = new TerraDrawRectangleMode({
				clickAndDrag: true,
				pointerEvents: {
					...DefaultPointerEvents,
		...
		it("with clickAndDrag true it finishes the rectangle", () => {
			rectangleMode = new TerraDrawRectangleMode({
				clickAndDrag: true,
			});
