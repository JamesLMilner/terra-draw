...
const example = {
    ...
    initLeaflet(id: string) {
      ...
      <div class="current">
        ...
        <span><b>Geometry Type</b> ${selected ? selected.geometry.type : "N/A"
                } </span>
        <span><b>Created</b> ${selected ? getHHMMSS(selected.properties.createdAt as number) : "N/A"
                } </span>
        <span><b>Updated</b> ${selected ? getHHMMSS(selected.properties.updatedAt as number) : "N/A"
                } </span>
      ...
      <div class="all">
        ...
        <span><b>Polygons:</b> ${features.filter((f) => f.geometry.type === "Polygon").length
                }</span>
        <span><b>LineStrings:</b> ${features.filter((f) => f.geometry.type === "LineString").length
                }</span>
        <span><b>Points:</b> ${features.filter((f) => f.geometry.type === "Point").length
                }</span>
      </div>
    `;
        };
