...
`TerraDrawLineStringMode`, `TerraDrawPolyLineMode`, `TerraDrawPolygonMode`, `TerraDrawRectangleMode`, `TerraDrawAngledRectangleMode`, `TerraDrawSectorMode`, and `TerraDrawSensorMode` support rendering _coordinate points_ (small point features rendered at each vertex of the geometry).
