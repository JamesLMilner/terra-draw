...
This package is for the Terra Draw Leaflet Adapter. Terra Draw aims to provide frictionless drawing across mapping libraries. 
...
To get started with the Leaflet adapter, please see the detailed [guide on adapters in the GitHub repository](https://github.com/JamesLMilner/terra-draw/blob/main/guides/1.ADAPTERS.md) to understand which are supported and how to get started with them
