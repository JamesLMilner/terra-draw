...
describe("ClosingPointsBehavior", () => {
    ...
    describe("api", () => {
        ...
        beforeEach(() => {
            ...
            startEndPointBehavior = new ClosingPointsBehavior(config, new PixelDistanceBehavior(config));
        });
        ...
        describe('isClosingPoint', () => {
            ...
            it('returns isClosing as true when in vicinity of closing point', () => {
                ...
                const { isClosing, isPreviousClosing } = startEndPointBehavior.isClosingPoint(mockDrawEvent({ containerX: 0, containerY: 0 }));
